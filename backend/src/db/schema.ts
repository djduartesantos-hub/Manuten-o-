...
export const tenants = pgTable(
  'tenants',
  {
    ...
    password_min_length: integer('password_min_length').notNull().default(10),
    password_expiration_days: integer('password_expiration_days'),
    password_max_failed_attempts: integer('password_max_failed_attempts').notNull().default(10),
    password_lockout_minutes: integer('password_lockout_minutes').notNull().default(15),
...
export const users = pgTable(
  'users',
  {
    ...
    password_changed_at: timestamp('password_changed_at', { withTimezone: true }).defaultNow().notNull(),
