...
start "CMMS Backend" cmd /k "cd /d "%cd%\backend" && cls && echo Starting Backend... && timeout /t 2 /nobreak && npm run dev"
...
start "CMMS Frontend" cmd /k "cd /d "%cd%\frontend" && cls && echo Starting Frontend... && timeout /t 2 /nobreak && npm run dev"
