    ...
    <MainLayout>
      <div className="space-y-8 font-display">
        <section className="relative overflow-hidden rounded-[32px] border theme-border glass-panel p-6 shadow-sm">
          ...
          <div className="absolute -left-16 bottom-0 h-44 w-44 rounded-full bg-amber-200/40 blur-3xl" />
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.3em] theme-text-muted">Operador</p>
              <h1 className="mt-2 text-3xl font-semibold theme-text">Criar e acompanhar ordens</h1>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <section className="rounded-2xl border theme-border glass-panel p-5 shadow-sm">
          ...
          <form onSubmit={submit} className="mt-4 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="input mt-2 min-h-[120px] rounded-2xl px-4 py-3 text-sm"
                disabled={loading || creating || !selectedPlant}
                rows={4}
              />
            </div>
            ...
            <button
              ...
              className="btn-primary w-full rounded-2xl px-4 py-3 text-sm font-semibold disabled:cursor-not-allowed disabled:opacity-60"
            >
          ...
          <section className="rounded-2xl border theme-border glass-panel p-5 shadow-sm">
            ...
            {mine.length === 0 ? (
              <p className="text-sm theme-text-muted">Ainda nao criou ordens.</p>
            ) : (
              <div className="space-y-3">
                {mine.map((o) => (
                  <div key={o.id} className="rounded-2xl border theme-border bg-[color:var(--dash-panel)] p-4">
