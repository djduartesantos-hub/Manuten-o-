      ...
      <div className="space-y-8 font-display">
        <section className="relative overflow-hidden rounded-[32px] border theme-border glass-panel p-6 shadow-sm">
          ...
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.3em] theme-text-muted">Tecnico</p>
              <h1 className="mt-2 text-3xl font-semibold theme-text">Ordens de trabalho</h1>
              <p className="mt-1 text-sm theme-text-muted">Primeiro as atribuidas a si, depois as disponiveis.</p>
            </div>
